...
public abstract class Bar : MonoBehaviour
{
    ...
    void SetDelayedPercent(float newPercent)
    {
        ...
        UpdateDelayedBarGraphics(newPercent);
    }

    protected abstract void UpdateBarGraphics(float newPercent);
    protected abstract void UpdateDelayedBarGraphics(float newPercent);
}
